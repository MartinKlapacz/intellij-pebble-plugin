 ...
 * from the specification file <tt>/home/martin/pro/intellij-plugin-tutorial/src/main/kotlin/com/github/martinklapacz/intellijplugintutorial/lang/grammars/Pebble.flex</tt>
 */
class PebbleLexer implements FlexLexer {
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { yybegin(YYINITIAL); return PebbleTypes.KEY;
            } 
            // fall through
          case 8: break;
          case 2: 
          ...
          case 10: break;
          case 4: 
            { yybegin(YYINITIAL); return PebbleTypes.COMMENT;
            } 
            // fall through
          case 11: break;
          case 5: 
            { yybegin(WAITING_VALUE); return PebbleTypes.SEPARATOR;
            } 
            // fall through
          case 12: break;
          case 6: 
            { yybegin(YYINITIAL); return PebbleTypes.VALUE;
            } 
            // fall through
          case 13: break;
          case 7: 
